...
function obj:addMenuItems(menuItems)
    ...
    if next(obj.arrangements) ~= nil then
        for k, i in pairs(obj.arrangements) do
            print(k)
            print(i)
...
function obj:bindHotkeys()
    ...
    if next(obj.arrangements) ~= nil then
        local index = 1
        for k, i in pairs(obj.arrangements) do
            hs.hotkey.bind({"ctrl", "alt"},tostring(index), function()
                obj:arrange(k)
            end)
            --hotkey.bind({"ctrl", "alt"}, 'j', obj:arrange(k))
            print("oiiiiii")
            print(index)
            index = index + 1    
        end
